...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 23 15:13:04 2019
...
for n in n_value_array:
    ...
    for iter in range(num_epoch):
        ...
        if (iter %100 ==0) and (iter >0):
            print("Error for Normal SGD Current iter: ",iter,"  Error: ", np.round(normal_sgd_error,4))
            #print("prediction", layer_4_act[:10])
    ...
    print("Final Error for Noisy SGD Current iter: ",iter,"  Error: ", np.round(ADDITIVE_sgd_error,4))
    print("\n---------------------------------\n\n")
